...
//#define portTICK_PERIOD_MS		( (TickType_t) _BV( portUSE_WDTO + 4 ) )	// Inaccurately assuming 128 kHz Watchdog Timer.
#define portTICK_PERIOD_MS	portUSE_TICK_PERIOD_MS // If you want accuracy, read datasheet.
...
#if defined(__AVR_ATmega2560__) || defined(__AVR_ATmega2561__) // ||  defined(__AVR_ATmega128__)
